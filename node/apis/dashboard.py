...
@dashboard_router.get(
    "/logout",
    tags=[
        DashboardAPITags.GENERAL_API.name
    ],
    # response_model=[LoginInput, LoginOutput], # Not sure if this was applicable.
...
@dashboard_router.get(
    "/applicants",
    tags=[
        DashboardAPITags.EMPLOYER_ONLY_API.name
    ],
...
async def get_applicants(
    applicant_count: int | None = Query(
        ItemReturnCount.MIN,
...
@dashboard_router.get(
    ...
    tags=[
        ExplorerAPITags.EMPLOYER_ONLY_API.name
    ],
...
async def get_applicant(applicant_id: int""", app_context: ApplicantDetail"""): # TODO: Require custom types.
    pass

@dashboard_router.get(
    "/requests",
    tags=[
        DashboardAPITags.CLIENT_ONLY_API.name
    ],
...
async def request_document_view(request_id: int, doc_type: str): # TODO: Types. | doc_type should have choices.
    pass

@dashboard_router.get(
    "/issuances",
    tags=[
        DashboardAPITags.INSTITUTION_ONLY_API.name
    ],
...
@dashboard_router.get(
    "/students",
    tags=[
        DashboardAPITags.INSTITUTION_ONLY.name
    ],
...
@dashboard_router.get(
    "/student/{student_id}",
    tags=[
        DashbardAPITags.INSTITUTION_ONLY_API.name
    ],
